...
Open Tracker.pro in Qt Creator.

Ensure your build kit is pointed to your OpenCV installation paths.

Click Build and Run.

🎮 How to Use
Launch the App: The application will open your default webcam (device 0).

Select ROI: A static frame will appear. Click and drag your mouse to draw a box around the object you want to track.

Confirm: Press Enter or Space to begin tracking.

Track: The yellow box will follow the object. If tracking is lost, a notification will appear on the top-left of the screen.
